 ...
 * Template Name: Blog
 *
 * The template for rendering blog posts.
 */
?>
...
<div id="wrapper">
	<div class="container">
 		<div class="row">
			...
			<div id="main" class="<?php echo 'full_width_layout' == $presentation_options['layout'] ? 'span12 fullwidth' : 'span8'; ?> clearfix" role="main"><div class="solid">

<h1 class="heading">What is BackPack Love?</h1></div>
